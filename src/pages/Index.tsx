    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[70vh] min-h-[500px] w-full overflow-hidden">
        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-center px-4 text-center">
          ...
          <Button
            size="lg"
            className="bg-accent hover:bg-accent/90 text-white font-semibold px-8 py-6 text-lg rounded-full shadow-lg hover:shadow-xl transition-all hover:scale-105"
            asChild
          >
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="space-y-6 text-lg leading-relaxed text-foreground/90">
            ...
            <div className="my-8 rounded-2xl bg-card p-8 shadow-[var(--shadow-soft)]">
              <h3 className="mb-4 text-2xl font-semibold text-primary">Flexible Membership Plans</h3>
      ...
      <section className="px-4 py-20 sm:px-8 md:px-16 lg:px-32">
        <div className="mx-auto max-w-5xl">
            ...
            {images.map((_, idx) => (
              <button
                ...
                className={`h-3 w-3 rounded-full transition-all ${
                  idx === current ? "bg-primary w-8" : "bg-border hover:bg-primary/50"
                }`}
          ...
          <div className="mt-12 text-center">
            <Button
              size="lg"
              className="bg-primary hover:bg-primary/90 text-white font-semibold px-10 py-6 text-lg rounded-full shadow-lg hover:shadow-xl transition-all hover:scale-105"
              asChild
            >
              <a href="https://www.tecgrw.com/contact" target="_blank" rel="noopener noreferrer">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <div>
              ...
              <div className="space-y-2 text-sm">
                <a href="https://www.tecgrw.com/privacy" target="_blank" rel="noopener noreferrer" className="block hover:text-primary transition-colors">
                  Privacy Policy
                </a>
                <a href="https://www.tecgrw.com/terms" target="_blank" rel="noopener noreferrer" className="block hover:text-primary transition-colors">
                  Terms of Use
                </a>
              </div>
            </div>
            <div>
              ...
              <div className="space-y-2 text-sm">
                <a href="https://www.instagram.com/tecgrw/" target="_blank" rel="noopener noreferrer" className="block hover:text-primary transition-colors">
                  Instagram
                </a>
                <a href="https://www.facebook.com/tecGrw1/" target="_blank" rel="noopener noreferrer" className="block hover:text-primary transition-colors">
                  Facebook
                </a>
              </div>
            </div>
